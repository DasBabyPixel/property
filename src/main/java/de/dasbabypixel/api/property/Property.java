...
public interface Property<T> {
    ...
    /**
     * Invalidates this property. This also invalidates all dependants. Called when value is changed
     */
    @Api
    void invalidate();

    /**
     * Invalidates all dependants and all dependencies of this property! This behaves like {@link #invalidate()} but also invalidates dependencies
     */
    @Api
    void invalidateAll();
