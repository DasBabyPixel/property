...
public interface NumberValue extends Property<AbstractNumberHolder> {
    ...
    @Api
    static NumberValue withStorage(IntegerStorage storage) {
        return NumberProperty.withStorage(storage);
    }

    @Api
    static NumberValue withStorage(LongStorage storage) {
        return NumberProperty.withStorage(storage);
    }

    @Api
    static NumberValue withStorage(DoubleStorage storage) {
        return NumberProperty.withStorage(storage);
    }

    @Api
    static NumberValue withStorage(FloatStorage storage) {
        return NumberProperty.withStorage(storage);
    }
